...
$sql = "SELECT id, titulo, fecha FROM consultas_docente WHERE estado = 'pendiente' AND idDocente = $idDocente";
...
<?php while ($row = $resultado->fetch(PDO::FETCH_ASSOC)) :  $hayResultado_contestada = true ?>
  ...
  <div>
    ...
    <div class="datos-consulta-flex">
        ...
        <div class="flex-consultas-datos">
            <div id="btn-consulta">
                <a <?php echo "href=./contestar.php?id=${row['id']}&n=$nombre&a=$apellido" ?> class="btn-consulta bg-main">
                    <p>Contestar</p>
